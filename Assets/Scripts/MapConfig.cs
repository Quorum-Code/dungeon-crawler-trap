...
public class MapConfig : MonoBehaviour
{
    ...
    public DungeonLayout Dungeon6()
    {
        ...
        d.AddLine("XTX XXXX    XX X"); // 9
        d.AddLine("X X XX   TT    X"); // 8
        d.AddLine("X   XX X    XXXX"); // 7
        d.AddLine("X X XX XXXXXX"); // 6
        d.AddLine("X X XX     X"); // 5
        d.AddLine("X XTXX X X X"); // 4
        d.AddLine("X    X XTX X"); // 3
        d.AddLine("X    X X X X"); // 2
        d.AddLine("X    S     X"); // 1
        ...
        d.AddPotion(new Point(14, 15), potionPrefabs[0]);
        d.AddPotion(new Point(1, 1), potionPrefabs[0]);
